...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Sep 08 22:14:57 CEST 2021
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	System.out.println("Estoy en RETURN " + exp);
	...
	System.out.println("Estoy en el else (SINO)");
	RESULT = ls;
	...
	System.out.println("Estoy en el else Función (SINO)");
	RESULT = ls;
	...
	System.out.println("Estoy en el if " + exp);
	if(exp.getType().equals(scopeManager.searchType("LOGICO"))){
		System.out.println("Es de tipo lógico");
		Sentencia s = new Sentencia();
	...
	System.out.println("ESTOY EN LA SEGUNDA PARTE DE FUNCIÓN " +id);
	...
	if (lista != null){
		for (int i = 0; i < lista.size(); i++) {
			...
			if(symTable.containsSymbol(lista.getVariable(i).getId())){
				...
				System.out.println(lista.getVariable(i).getTipo());
				//TypeIF type = scopeManager.searchType(lista.getVariable(i).getTipo());			

				
				SymbolParameter parametro = new SymbolParameter(scope, lista.getVariable(i).getValor(), lista.getVariable(i).getType());
				System.out.println(parametro);
				symTable.addSymbol(parametro);	
				System.out.println("Añadido parametro");
				System.out.println(scopeManager.containsSymbol(id.getLexema()));
				...
				System.out.println(funcion.getRetorno());
			}		
		}
	}
	...
	System.out.println("ESTOY EN LA FUNCIÓN " +id);
	ScopeIF scope = scopeManager.getCurrentScope();
	SymbolTableIF symTable = scope.getSymbolTable();
	TypeTableIF typeTable = scope.getTypeTable();
	...
	System.out.println("Entro en deftipos");
	...
	System.out.println("valorconstante" +n.getLexema());
	System.out.println(scopeManager.getCurrentScope());
	Constante c = new Constante(scopeManager.searchType("ENTERO"), n.getLexema());
	System.out.println(scopeManager.searchType("ENTERO"));
	...
	System.out.println("Entro en defconstantes");
	...
	System.out.println("DEFPRINCIPAL...");
	...
	System.out.println("AXIOM..." +df.getIntermediateCode());
	System.out.println(scopeManager.getCurrentScope());
	ScopeIF scope = scopeManager.getCurrentScope();
	IntermediateCodeBuilder cb = new IntermediateCodeBuilder(scope);                     
		...
		for (ScopeIF scope: scopes) {
			...
			for (TemporalIF t: temporals) {
				if (t instanceof Temporal) {
					System.out.println("For temporal "+ t);
					System.out.println(t.getAddress());
					((Temporal)t).setAddress(direccionEstatica);
					System.out.println(t.getAddress());
					System.out.println("Antes direccionEstatica " + direccionEstatica);
					direccionEstatica = direccionEstatica - ((Temporal)t).getSize();
					System.out.println("Despues direccionEstatica " + direccionEstatica);
				}
			} 	 
		}
		for (ScopeIF scope: scopes) {
			...
			if(scope.getLevel() == 0) {
				...
				for(SymbolIF simbolo: simbolos) {
					if(simbolo instanceof SymbolVariable) {
						...
						System.out.println("Antes de VARGLOBAL " + var.getAddress());
