...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Aug 21 19:24:41 CEST 2021
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	if(scopeManager.searchSymbol(id.getLexema()) == null) {
		...
		Expresion ex = new Expresion (scopeManager.searchSymbol(id.getLexema()).getType().getName(), id.getLexema());
		RESULT = ex;
	}
	...
	System.out.println (" Estoy en expresion/id ");
	Expresion exp = new Expresion(null, id.getLexema());
	//Si contiene el símbolo poner el tipo...(contains)
	if(scopeManager.containsSymbol(id.getLexema())){
		//Poner el tipo
		exp.setTipo(scopeManager.searchSymbol(id.getLexema()).getType().getName());
	}	
	RESULT = exp;
	...
	Var v = new Var(id.getLexema(), null);
	RESULT = v;
	...
	for (int i = 0; i < lista.size(); i++) {
		...
		if(symTable.containsSymbol(lista.getVariable(i).getId())){
			...
			if (type == null) {
				...
				SymbolVariable simboloVariable = new SymbolVariable(scope, lista.getVariable(i).getValor(), type);
	...
	if(ex.getTipo() == null){
		...
		Var var = new Var (ex.getTipo(), ex.getValor());
		RESULT = var;
	}
